...
import 'package:shopnestfrontend/presentation/screens/order/provider/order_detail_provider.dart';
      ...
      body: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              PrimaryButton(
                  onPressed: () async {
                     OrderModel? success = await BlocProvider.of<OrderCubit>(context).createOrder(
